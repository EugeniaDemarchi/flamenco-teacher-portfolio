...
export const clases: Clase[] = [
  ...
  },
  {
    ...
    descripcionCorta:
      "Técnica, musicalidad y abanico en una de las danzas más refinadas del flamenco.",

    descripcionLarga:
      "Una propuesta para profundizar en la Guajira a través del trabajo con abanico, explorando la relación entre el movimiento, el ritmo y la expresividad. La clase combina técnica, secuencias coreográficas e interpretación para potenciar la presencia escénica de cada bailaora.",
    ubicacion: {
      direccion: "French 266",
      mapsUrl:
        "https://www.google.com/maps/place/French+266,+B1828HKF+Banfield,+Provincia+de+Buenos+Aires/@-34.7426342,-58.4006939,17z/data=!3m1!4b1!4m5!3m4!1s0x95bcd29e37689f83:0xb3894f33e277cba8!8m2!3d-34.7426342!4d-58.398119?entry=ttu&g_ep=EgoyMDI2MDgwMi4wIKXMDSoASAFQAw%3D%3D",
      barrio: "Banfield",
    },
  },
];
